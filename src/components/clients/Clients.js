...
function Clients() {
  ...
  return (
    <div className="clientMain  pb-8 flex flex-col  justify-center">
      <p className="text-darkBlue mx-auto title">
        Distributed teams brought together
      </p>
      <div className="mx-auto list flex ">
        <img src={client1} alt="" className="object-center"></img>
        <img src={client2} alt="" className="object-center"></img>
        <img src={client3} alt="" className="object-center"></img>
        <img src={client4} alt="" className="object-center"></img>
        <img src={client5} alt="" className="object-center"></img>
        <img src={client6} alt="" className="object-center"></img>
      </div>
      <p className="mx-auto text-darkBlue title mb-8">
        Engage your remote team
      </p>
      <p className="text-darkBlue mx-auto paragraph mb-5">
